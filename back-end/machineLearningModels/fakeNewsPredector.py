...
#the path is relative to server.py
loaded_model = pickle.load(open(r'./machineLearningModels/model.pkl', 'rb'))
# dataframe = pd.read_csv(r'C:\Users\elGhizi\Desktop\fakeNews\ProjetFinModule\scrapping\FakeNews.txt', delimiter = ";")
#the path is relative to server.py
dataframe = pd.read_csv(r'../scrapping/FakeNews.txt', delimiter = ";")
x = dataframe['text']
y = dataframe['label']
